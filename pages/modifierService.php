...
<?php
    ...
    $rq="select * from service where id_service= '$id_service'";
    $result=$pdo->query($rq);
    $service=$result->fetch();
    $nomservice=$service['NOMSERVICE'];
    $abv=$service['ABVNOMSERVICE'];
    $etage=$service['ETAGE'];
?> 
...
<body>
    ...
    <div class="container">
        <div class="card margetop">
            <h6 class="card-header" style="color:green;">Modification service</h6>
            <div class="card-body">
                <form method="POST" action="updateService.php" class="form">
                    <label>id Service : <?php echo $id_service ?> </label>
                    <div class="form-group">
                        <input type="text" name="id_service" id="id_service" class="form-control" value="<?php echo $id_service ?>" hidden>
                    </div>
                    <label>nom Service</label>
                    <div class="form-group">
                        <input type="text" name="nomservice" id="nomservice" class="form-control" value="<?php echo $nomservice ?>">
                    </div>
                    <label>abreviation service</label>
                    <div class="form-group">
                        <input type="text" name="abv" id="abv" class="form-control" value="<?php echo $abv ?>">
                    </div>
                    ...
                    <label>Etage</label>
                    <div class="form-group">
                        <input type="number" name="etage" id="etage" value="<?php echo $etage?>" class="form-control">
